      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
        ...
        >
          <Link href="/" className="group inline-flex items-center gap-2.5">
            <AppLogo
              src="/assets/images/app_logo_transparent.svg"
              size={38}
              iconName="QrCodeIcon"
          ...
          >
            <span
              className={`h-0.5 w-5 rounded-full bg-primary transition-all duration-300 ${menuOpen ? 'translate-y-2 rotate-45' : ''}`}
            />
            <span
              className={`h-0.5 w-5 rounded-full bg-primary transition-all duration-300 ${menuOpen ? 'opacity-0' : ''}`}
            />
            <span
              className={`h-0.5 w-5 rounded-full bg-primary transition-all duration-300 ${menuOpen ? '-translate-y-2 -rotate-45' : ''}`}
            />
